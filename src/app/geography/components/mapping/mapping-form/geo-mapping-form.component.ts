...
@Component({
  ...
  selector: 'app-geo-mapping-form',
  templateUrl: './geo-mapping-form.component.html',
  styleUrls: ['./geo-mapping-form.component.scss']
})
export class GeoMappingFormComponent implements OnInit {
...
@NgModule({
  ...
  exports: [GeoMappingFormComponent],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    ButtonModule,
...
export class GeoMappingFormModule {}
